...
from PyQt6.QtWidgets import (
    ...
    QLabel, QPushButton, QSplitter, QGroupBox, QTabWidget,
    ...
    for y in range(size[1]):
        ...
        if channel <= 6:  # Visible
            draw.line([(0, y), (size[0], y)], 
                      fill=(150 + color_value//2, 150 + color_value//2, 220 - color_value))
        elif channel <= 10:  # Water vapor
            draw.line([(0, y), (size[0], y)], 
                      fill=(20, 20, 120 + color_value))
        else:  # IR
            if enhance:
                ...
                if y < size[1] / 3:
                    ...
                    draw.line([(0, y), (size[0], y)], fill=(0, 100 + color_value//2, 200 - color_value//2))
            else:
...
class TestWindow(QMainWindow):
    ...
    def add_initial_samples(self):
        ...
        QTimer.singleShot(100, lambda: self.add_sample_preview(8, "Water Vapor Example", enhanced=True))
