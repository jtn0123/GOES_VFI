...
def test_theme_manager():
    ...
    try:
        ...
        valid_themes = [
            "dark_teal", "dark_blue", "dark_amber", "dark_cyan", 
            "dark_lightgreen", "dark_pink", "dark_purple", "dark_red", "dark_yellow"
        ]
        for theme in themes:
...
def test_file_migrations():
    ...
    migration_tests = [
        ("ThemeManager", "goesvfi/gui_components/theme_manager.py", ["qt_material", "AVAILABLE_THEMES"]),
