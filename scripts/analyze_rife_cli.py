...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description='Analyze RIFE CLI executable capabilities')
    parser.add_argument('executable', type=str, help='Path to the RIFE CLI executable')
    parser.add_argument('--json', action='store_true', help='Output in JSON format')
    parser.add_argument('--verbose', '-v', action='store_true', help='Show verbose output including help text')
