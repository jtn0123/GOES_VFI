...
content = content.replace(logger_line, f"{logger_line}\n\n{preview_metadata_def}")
...
methods_to_fix = [
    ...
    (r"def clearImage\(self\):", r"def clearImage(self) -> None:"),
    (
    ...
    (r"def updateButtonStatus\(self\):", r"def updateButtonStatus(self) -> None:"),
    (r"def clearMetadata\(self\):", r"def clearMetadata(self) -> None:"),
    (
        r"def setInfoText\(self, message, status_type='info'\):",
        r"def setInfoText(self, message: str, status_type: str = 'info') -> None:",
    ),
    (r"def updateLayout\(self\):", r"def updateLayout(self) -> None:"),
]
...
section_methods = [
    ...
    (r"def create_data_section\(self\):", r"def create_data_section(self) -> QWidget:"),
    (
...
remaining_methods = [
    (r"def resetSettings\(self\):", r"def resetSettings(self) -> None:"),
    (r"def applySettings\(self\):", r"def applySettings(self) -> None:"),
]
...
fixed_previews_cache = (
    "self.preview_cache: Dict[str, Dict[str, Union[QPixmap, PreviewMetadata]]] = {}"
)
