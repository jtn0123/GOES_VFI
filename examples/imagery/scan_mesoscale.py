...
print("\nSuggestions to try:")
print(
"1. Try a different day - mesoscale sectors move based on weather events"
)
print("2. Try scanning both M1 and M2 sectors")
print("3. Try a date range within the last year for better availability")
