...
"""
print("Processing improved true color image from band files")
...
date_str, hour, satellite="GOES16", sector="F", output_dir=None, advanced=True
):
    """
...
success = process_improved_true_color(
downloaded_files, output_path, advanced_enhancements=advanced
)
...
description="Download and process improved GOES true color imagery"
)
parser.add_argument(
"--date",
type=str,
