...
def main():
    ...
    parser.add_argument('--mode', type=str, choices=['single', 'compare', 'modes'], default='single',
                        help='Test mode')
    parser.add_argument('--channel', type=int, default=13,
                        help='Channel number (default: 13 - Clean IR)')
    parser.add_argument('--product', type=str, choices=['full_disk', 'meso1', 'meso2', 'cmip', 'rain_rate'],
                        default='full_disk', help='Product type')
