...
async def download_mesoscale_minute_by_minute(satellite, date_str, hour="18", minute_range=5):
    """
        ...
        for file_key in files:
            ...
            if success:
                ...
                if "_s" in base_filename:
                    ...
                    truecolor_path = region_dir / f"{satellite_abbr}_{region}_{time_code}_truecolor.png"
                    ir_path = region_dir / f"{satellite_abbr}_{region}_{time_code}_ir13.png"
...
async def download_recent_mesoscale(satellite="GOES-18", hours_back=1):
    ...
    return await download_mesoscale_minute_by_minute(satellite, date_str, hour, minute_range=5)
