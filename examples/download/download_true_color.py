...
def download_and_process_true_color(date_str, hour, satellite="GOES16", sector="F", output_dir=None):
    """
...
def main():
    parser = argparse.ArgumentParser(description="Download and process GOES true color imagery")
