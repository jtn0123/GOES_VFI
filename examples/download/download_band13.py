...
async def download_fixed_list():
    ...
    KNOWN_FILES = [
        # GOES-16 RadC
        ("noaa-goes16", "ABI-L1b-RadC/2023/166/12/OR_ABI-L1b-RadC-M6C13_G16_s20231661201176_e20231661203561_c20231661204041.nc"),
        # GOES-18 RadC
        ("noaa-goes18", "ABI-L1b-RadC/2023/166/12/OR_ABI-L1b-RadC-M6C13_G18_s20231661201181_e20231661203567_c20231661204040.nc"),
    ]
...
async def main():
    ...
    LOGGER.info(f"Please check this directory to view the downloaded files.")
