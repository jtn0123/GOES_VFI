...
def main():
    ...
    parser = argparse.ArgumentParser(description="Download pre-processed GOES satellite images from NOAA's CDN")
    ...
    parser.add_argument("--product", choices=list(PRODUCTS.keys()), default="GEOCOLOR",
    ...
    parser.add_argument("--output-dir", default="~/Downloads/goes_quicklook",
    ...
    parser.add_argument("--timestamp", 
                      help="Specific timestamp to download (format: YYYYMMDD_HHMMSS)")
    ...
    print(f"Downloading {args.satellite} {SECTORS[args.sector]} {PRODUCTS[args.product]} images")
    ...
    if args.timestamp:
        ...
        try:
            ...
            url = build_url(args.satellite, args.sector, args.product, timestamp, args.resolution)
        ...
        print(f"Searching for latest available image (up to {args.hours_back} hours back)...")
