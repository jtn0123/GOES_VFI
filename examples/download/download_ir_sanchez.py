...
def main():
    parser = argparse.ArgumentParser(description="Download and process GOES IR imagery with Sánchez colorization")
    ...
    parser.add_argument("--sector", choices=["F", "C", "M1", "M2"], default="F",
