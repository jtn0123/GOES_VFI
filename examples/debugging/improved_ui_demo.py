...
from PyQt6.QtWidgets import (
    ...
    QTabWidget, QSplitter, QPushButton, QLabel, QComboBox
)
from PyQt6.QtCore import Qt, QSize

# Import dark mode styling
from goesvfi.integrity_check.dark_mode_style import apply_dark_mode_palette, DARK_MODE_STYLESHEET
...
from goesvfi.integrity_check.visual_date_picker import (
    VisualDateRangePicker, TimelinePickerWidget
)
from goesvfi.integrity_check.timeline_visualization import (
    TimelineVisualization, MissingDataCalendarView
)
...
from goesvfi.integrity_check.results_organization import (
    MissingItemsTreeView, ResultsSummaryWidget, ItemPreviewWidget
)
...
class ImprovedUIDemo(QMainWindow):
    ...
    def _create_timeline_tab(self) -> QWidget:
        ...
        self.optimized_timeline.timestampSelected.connect(self._handle_timestamp_selected)
