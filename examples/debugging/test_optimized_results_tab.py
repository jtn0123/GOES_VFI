...
self.assertEqual(received_item, test_item, "Item signal not emitted with correct item")
...
# Verify the signal was emitted with the correct item
self.assertEqual(received_item, test_item, "View signal not emitted with correct item")
