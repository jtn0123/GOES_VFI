...
def main():
    parser = argparse.ArgumentParser(description="List contents of a GOES S3 bucket directory")
    parser.add_argument("--bucket", default="noaa-goes16",
                        help="S3 bucket name (default: noaa-goes16)")
