    ...
    try:
        ...
        for page in page_iterator:
            if "Contents" in page:
                ...
                matching = [obj["Key"] for obj in page["Contents"] 
...
def main():
    ...
    if found_files:
        print("\nSummary:")
        print(f"Found Mesoscale {args.sector} Band {args.band} imagery in {len(found_files)} hours")
        ...
        print(f"python download_ir_simple.py --date {args.year}-MM-DD --hour {example_hour} " +
        ...
        print("\nSuggestions to try:")
        print(f"1. Try a different day - mesoscale sectors move based on weather events")
