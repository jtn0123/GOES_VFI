    ...
    if "CommonPrefixes" in result:
        ...
        if years:
            ...
            if "CommonPrefixes" in day_result:
                days = [
                    prefix["Prefix"].strip("/")
                    for prefix in day_result["CommonPrefixes"]
                ]
                ...
                if days:
                    ...
                    hour_result = s3.list_objects_v2(
                        Bucket=bucket,
                        Prefix=f"{latest_year}/{latest_days[-1]}/",
                        MaxKeys=max_keys,
                        Delimiter="/",
                    )
                    ...
                    if "CommonPrefixes" in hour_result:
                        hours = [
                            prefix["Prefix"].strip("/")
                            for prefix in hour_result["CommonPrefixes"]
                        ]
                        ...
                        if hours:
                            ...
                            example_path = (
                                f"{latest_year}/{latest_days[-1]}/{latest_hours[-1]}/00"
                            )
