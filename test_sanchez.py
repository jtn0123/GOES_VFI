...
def test_basic_call(input_path, res_km=4):
    ...
    cmd = [str(bin_path), "-s", str(input_path), "-o", str(temp_output), "-r", str(res_km)]
...
def test_with_verbose(input_path, res_km=4):
    ...
    cmd = [str(bin_path), "-s", str(input_path), "-o", str(temp_output), "-r", str(res_km), "--verbose"]
...
def test_with_v_flag(input_path, res_km=4):
    ...
    cmd = [str(bin_path), "-s", str(input_path), "-o", str(temp_output), "-r", str(res_km), "-v"]
...
def test_with_renamed_input(input_path, res_km=4):
    ...
    cmd = [str(bin_path), "-s", str(temp_input), "-o", str(temp_output), "-r", str(res_km)]
