...
class SanchezProcessor(ImageProcessor):
    ...
    def __init__(self, temp_dir: Path, progress_callback: Optional[Callable[[str, float], None]] = None):
        ...
        try:
            ...
            try:
                ...
                processed_data = ImageData(
                    ...
                    channels=len(processed_array.shape) if len(processed_array.shape) == 2 else processed_array.shape[2],
