...
class MessageLogDialog(QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle(self.tr("Message History"))
        ...
        self.copy_button = QPushButton(self.tr("Copy Selected"))
        self.copy_button.clicked.connect(self._copy_selected)
        button_layout.addWidget(self.copy_button)

        self.copy_all_button = QPushButton(self.tr("Copy All"))
...
class EnhancedProgressDialog(QDialog):
    ...
    def __init__(self, title: str, parent: Optional[QWidget] = None) -> None:
        ...
        # Task description
        self.description_label = QLabel(self.tr("Preparing..."))
        ...
        # ETA label
        self.eta_label = QLabel(self.tr("Estimated time remaining: Calculating..."))
        layout.addWidget(self.eta_label)

        # Create log widget for detailed progress
        log_group = QGroupBox(self.tr("Progress Details"))
    ...
    def _cancel_clicked(self) -> None:
        ...
        self.cancel_button.setText(self.tr("Canceling..."))
