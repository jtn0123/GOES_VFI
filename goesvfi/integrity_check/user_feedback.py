...
from PyQt6.QtWidgets import (
    ...
    QProgressBar, QDialog, QDialogButtonBox, QStatusBar,
    QMessageBox, QListWidget, QSplitter, QTabWidget, 
    QTextEdit, QGroupBox, QScrollArea, QFrame, QPlainTextEdit
)
from PyQt6.QtCore import (
    Qt, QObject, pyqtSignal, QTimer, QSize, QDateTime,
    QThreadPool, QRunnable
)
from PyQt6.QtGui import QColor, QIcon, QPixmap, QFont, QPalette
        ...
        if settings_path.exists():
            try:
                with open(settings_path, "r") as f:
                    ...
                    self._enable_desktop_notifications = settings.get("desktop_notifications", False)
...
class EnhancedStatusBar(QStatusBar):
    ...
    def update_status(self, message: str, message_type: MessageType = MessageType.INFO) -> None:
        """
...
class MessageLogDialog(QDialog):
    ...
    def __init__(self, feedback_manager: FeedbackManager, parent: Optional[QWidget] = None) -> None:
        """
        ...
        self.info_checkbox.setStyleSheet("QPushButton:checked { background-color: #3498db; }")
        ...
        self.success_checkbox.setStyleSheet("QPushButton:checked { background-color: #2ecc71; }")
        ...
        self.warning_checkbox.setStyleSheet("QPushButton:checked { background-color: #f39c12; }")
        ...
        self.error_checkbox.setStyleSheet("QPushButton:checked { background-color: #e74c3c; }")
        ...
        self.debug_checkbox.setStyleSheet("QPushButton:checked { background-color: #9b59b6; }")
    ...
    def _update_message_list(self) -> None:
        ...
        for message, message_type, timestamp in messages:
            # Apply filter
            if (message_type == MessageType.INFO and not show_info or
                message_type == MessageType.SUCCESS and not show_success or
                message_type == MessageType.WARNING and not show_warning or
                message_type == MessageType.ERROR and not show_error or
                message_type == MessageType.DEBUG and not show_debug):
                continue
    ...
    def _copy_selected(self) -> None:
        ...
        # Show confirmation
        self.feedback_manager.add_message("Selected messages copied to clipboard", MessageType.INFO)
    ...
    def _copy_all(self) -> None:
        ...
        # Show confirmation
        self.feedback_manager.add_message("All messages copied to clipboard", MessageType.INFO)
