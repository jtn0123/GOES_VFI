...
class SharedPreviewPanel(QWidget):
    ...
    def initUI(self):
        ...
        # Labels for metadata
        self.info_channel = QLabel("Channel: -")
        self.info_product = QLabel("Product: -")
        self.info_datetime = QLabel("Date/Time: -")
        self.info_source = QLabel("Source: -")
        
        # Info layout
        info_layout.addWidget(QLabel("Preview Information:"), 0, 0, 1, 2)
        ...
        action_layout.addWidget(QLabel("Zoom:"))
    ...
    def clearPreviews(self):
        ...
        if self.current_key and self.current_key not in self.preview_cache:
            ...
            self.image_label.setText("No preview available")
            self.info_channel.setText("Channel: -")
            self.info_product.setText("Product: -")
            self.info_datetime.setText("Date/Time: -")
    ...
    def getBookmarkedPreviews(self) -> Dict[str, Dict[str, Any]]:
        ...
        """
        return {key: self.preview_cache[key] for key in self.bookmarks if key in self.preview_cache}
    ...
    def createFallbackPreview(
        ...
        painter.drawText(status_rect, Qt.AlignmentFlag.AlignCenter, "STATUS: PREVIEW UNAVAILABLE")
        ...
        y += 20
        painter.drawText(20, y, f"Date/Time: {date_time.strftime('%Y-%m-%d %H:%M')} UTC")
        y += 25
        ...
        painter.drawText(20, y, "You can still proceed with processing using fallback imagery samples.")
...
class SidebarSettingsPanel(QWidget):
    ...
    def create_presets_section(self, group):
        ...
        quick_preview_btn = QPushButton("Quick Preview")
        quick_preview_btn.setIcon(QIcon.fromTheme("view-preview"))
        
        full_res_btn = QPushButton("Full Resolution")
        
        multi_channel_btn = QPushButton("Multi-Channel")
    ...
    def create_data_section(self, group):
        ...
        self.satellite_combo.addItem("GOES-16 (East)")
        self.satellite_combo.addItem("GOES-18 (West)")
        ...
        self.product_combo.addItem("Full Disk")
        self.product_combo.addItem("CONUS")
        self.product_combo.addItem("Mesoscale 1")
        self.product_combo.addItem("Mesoscale 2")
    ...
    def create_visualization_section(self, group):
        ...
        self.enhancement_combo.addItem("Standard (Grayscale)")
        self.enhancement_combo.addItem("Enhanced (Colorized)")
    ...
    def create_processing_section(self, group):
        ...
        self.resolution_combo.addItem("Full Resolution")
        self.resolution_combo.addItem("Medium (Faster)")
        self.resolution_combo.addItem("Low (Fastest)")
        ...
        # Add options
        self.preview_check = QCheckBox("Preview before processing")
        self.preview_check.setChecked(True)
        
        self.cache_check = QCheckBox("Cache downloaded data")
    ...
    def create_advanced_section(self, group):
        ...
        temp_group = QGroupBox("Temperature Range (K)")
        ...
        self.use_s3_check = QCheckBox("Use AWS S3 (Raw Data)")
        self.use_s3_check.setChecked(True)
        
        self.use_cdn_check = QCheckBox("Use NOAA CDN (Web Images)")
        self.use_cdn_check.setChecked(True)
        
        self.use_rammb_check = QCheckBox("Use RAMMB Slider (Alternative)")
