...
from PyQt6.QtCore import Qt, QDateTime, QDate, QTime, pyqtSignal, pyqtSlot, QSize, QTimer
...
class ImageSelectionPanel(QWidget):
    ...
    def initUI(self) -> None:
        ...
        for btn in [
            self.ch1_btn, self.ch2_btn, self.ch3_btn, 
            self.ch4_btn, self.ch5_btn, self.ch6_btn,
            self.ch7_btn, self.ch8_btn, self.ch9_btn, 
            self.ch10_btn, self.ch11_btn, self.ch12_btn,
            self.ch13_btn, self.ch14_btn, self.ch15_btn, 
            self.ch16_btn, self.true_color_btn, 
            self.wv_comp_btn, self.ir_comp_btn
        ]:
        ...
        for btn, channel in self.channel_mapping.items():
            tooltip = f"{channel.display_name} ({channel.wavelength})\n{channel.description}"
    ...
    def requestImage(self) -> None:
        ...
        # Get mode
        mode = ImageryMode.RAW_DATA if self.raw_data_btn.isChecked() else ImageryMode.IMAGE_PRODUCT
