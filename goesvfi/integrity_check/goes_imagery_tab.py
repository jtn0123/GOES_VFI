...
class ImageSelectionPanel(QWidget):
    ...
    def initUI(self) -> None:
        ...
        product_group = QGroupBox(self.tr("Product Type"))
        ...
        # Channel selection
        channel_group = QGroupBox(self.tr("Channel Selection"))
        channel_layout = QGridLayout(channel_group)

        # Add channel groups
        visible_group = QGroupBox(self.tr("Visible"))
        ...
        # Near-IR group
        nearir_group = QGroupBox(self.tr("Near-IR"))
        ...
        # Water Vapor group
        wv_group = QGroupBox(self.tr("Water Vapor"))
        ...
        # IR group
        ir_group = QGroupBox(self.tr("Infrared"))
        ...
        # Composites group
        comp_group = QGroupBox(self.tr("Composites"))
        ...
        # Mode selection
        mode_group = QGroupBox(self.tr("Image Source Mode"))
        ...
        # Processing options
        processing_group = QGroupBox(self.tr("Processing Options"))
        processing_layout = QGridLayout(processing_group)

        # Resolution options
        resolution_label = QLabel(self.tr("Resolution:"))
        self.resolution_combo = QComboBox()
        self.resolution_combo.addItem(self.tr("Native Resolution", "native"))
        self.resolution_combo.addItem(self.tr("2.7K", "2.7k"))
        self.resolution_combo.addItem(self.tr("1.2K", "1.2k"))
        self.resolution_combo.setCurrentIndex(1)  # Default to 2.7K

        # Processing level
        processing_label = QLabel(self.tr("Processing:"))
        ...
        size_label = QLabel(self.tr("Image Size:"))
        self.size_combo = QComboBox()
        self.size_combo.addItem(self.tr("600 px", "600"))
        self.size_combo.addItem(self.tr("1200 px", "1200"))
        self.size_combo.addItem(self.tr("2400 px", "2400"))
        ...
        # Download button
        self.download_btn = QPushButton(self.tr("Download Imagery"))
    ...
    def processImageRequest(self, request: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if image_path:
                ...
                self.view_panel.status_label.setText(self.tr("No image available"))
...
if __name__ == "__main__":
    ...
    window = QWidget()
    window.setWindowTitle(self.tr("GOES Imagery Tab Demo"))
