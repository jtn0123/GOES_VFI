...
class QuickDateDialog(QDialog):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        calendar_group = QGroupBox(self.tr("Custom Date Selection"))
        ...
        presets_group = QGroupBox(self.tr("Quick Presets"))
        presets_layout = QGridLayout()

        self.today_btn = QPushButton(self.tr("Today"))
        self.today_btn.clicked.connect(self._set_today)

        self.yesterday_btn = QPushButton(self.tr("Yesterday"))
        self.yesterday_btn.clicked.connect(self._set_yesterday)

        self.last_week_btn = QPushButton(self.tr("Last 7 Days"))
        self.last_week_btn.clicked.connect(self._set_last_week)

        self.last_month_btn = QPushButton(self.tr("Last 30 Days"))
...
class ImprovedEnhancedIntegrityCheckTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        date_layout.addWidget(QLabel(self.tr("Date Range:")))
        self.date_range_label = QLabel(self.tr("Yesterday (00:00 - 23:59)"))
        self.date_range_label.setStyleSheet("font-weight: bold;")
        self.date_select_button = QPushButton(self.tr("Change..."))
        self.date_select_button.setToolTip(self.tr("Select date range to scan"))
        ...
        self.advanced_options = QGroupBox(self.tr("Advanced Options"))
        ...
        # Satellite pattern
        advanced_layout.addWidget(QLabel(self.tr("Satellite:")), 0, 0)
        ...
        # Interval
        advanced_layout.addWidget(QLabel(self.tr("Interval:")), 0, 2)
        ...
        # Source
        advanced_layout.addWidget(QLabel(self.tr("Data Source:")), 1, 0)
        self.source_combo = QComboBox()
        self.source_combo.addItem(self.tr("Auto (Try All)", "auto"))
        self.source_combo.addItem(self.tr("Amazon S3", "s3"))
        self.source_combo.addItem(self.tr("NOAA CDN", "cdn"))
        ...
        results_header.addWidget(QLabel(self.tr("<b>Missing Timestamps</b>")))
        ...
        # Action buttons
        self.download_button = QPushButton(self.tr("Download Missing"))
        ...
        self.table_status_bar = QLabel(self.tr("0 items"))
    ...
    def _update_missing_items(self, items: List[MissingTimestamp]) -> None:
        ...
        if items:
            ...
            self.table_status_bar.setText(self.tr("0 items"))
