...
from PyQt6.QtWidgets import (
    ...
    QSizePolicy, QFrame, QToolTip, QStyleOption, QStyle
)
from PyQt6.QtCore import Qt, QRect, QRectF, QSize, QPoint, pyqtSignal, QTimer, QEasingCurve
...
class EnhancedTimeline(TimelineVisualization):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self.timeline_bg_color = QColor(55, 55, 55)   # Slightly lighter gray for timeline
    ...
    def _draw_grid(self, painter: QPainter) -> None:
        ...
        # Set up grid pen
        grid_pen = QPen(QColor(self.grid_color.red(), self.grid_color.green(), 
                             self.grid_color.blue(), int(255 * opacity)))
        ...
        while grid_time <= visible_end:
            ...
            # Calculate position
            position_ratio = ((grid_time - self.start_timestamp).total_seconds() / total_duration - self.viewport_start) * self.zoom_level
