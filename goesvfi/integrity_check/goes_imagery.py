...
class ChannelType(Enum):
    ...
    CH05 = (5, "Snow/Ice (Near-IR)", "1.6 μm", "Cloud-top phase, snow/ice discrimination")
    CH06 = (6, "Cloud Particle Size (Near-IR)", "2.2 μm", "Cloud particle size, snow cloud discrimination")
    CH07 = (7, "Shortwave Window IR", "3.9 μm", "Fire detection, fog detection, night fog, winds")
    CH08 = (8, "Upper-Level Water Vapor IR", "6.2 μm", "High-level moisture, winds, rainfall")
    CH09 = (9, "Mid-Level Water Vapor IR", "6.9 μm", "Mid-level moisture, winds, rainfall")
    CH10 = (10, "Lower-level Water Vapor IR", "7.3 μm", "Lower-level moisture, winds, rainfall")
    ...
    CH13 = (13, "Clean Longwave Window IR", "10.3 μm", "Surface temp, cloud detection, rainfall")
    CH14 = (14, "Dirty Longwave Window IR", "11.2 μm", "Sea surface temperature")
    CH15 = (15, "Mid-level Tropospheric CO2 IR", "12.3 μm", "Air temperature, cloud heights")
    CH16 = (16, "CO2 Longwave IR", "13.3 μm", "Air temperature, cloud heights")
    TRUE_COLOR = (100, "True Color", "RGB", "Natural color composite of channels 1, 2, 3")
    WATER_VAPOR = (101, "Water Vapor", "6.2/7.3/9.6 μm", "Atmospheric moisture at different levels")
...
class GOESImageryDownloader:
    ...
    def download_precolorized_image(self, 
                                    channel: ChannelType, 
                                    product_type: ProductType,
                                    date: Optional[datetime] = None,
                                    size: str = "1200") -> Optional[Path]:
        """
    ...
    def process_raw_data(self, 
        ...
        try:
            ...
            if self.mode == ProcessingMode.NONE:
                ...
                success = self._basic_processing(file_path, output_path, channel, resolution)
...
class GOESImageryManager:
    ...
    def get_imagery(self, 
        ...
        channel_obj: Optional[ChannelType] = channel if isinstance(channel, ChannelType) else None
