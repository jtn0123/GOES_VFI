...
class VisualDateRangePicker(QDialog):
    ...
    def __init__(
        ...
        self.start_date = start_date or (datetime.now(UTC) - timedelta(days=1))
...
class TimelinePickerWidget(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        # Initialize data
        self.start_date = datetime.now(UTC) - timedelta(days=7)
    ...
    def _generate_mock_data(self) -> list[Any]:
        ...
        while current <= self.end_date:
            ...
            if datetime.now(UTC).microsecond % (100 // 80) == 0:
