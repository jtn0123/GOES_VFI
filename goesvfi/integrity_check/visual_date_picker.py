...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLabel, QCalendarWidget, QTimeEdit,
    QButtonGroup, QRadioButton, QFrame, QSizePolicy
)
from PyQt6.QtCore import Qt, QDate, QTime, QDateTime, pyqtSignal, QSize
...
class VisualDateRangePicker(QDialog):
    ...
    def _setup_quick_presets(self, parent_layout: QVBoxLayout) -> None:
        ...
        preset_group.setStyleSheet("QFrame { background-color: #353535; border-radius: 4px; border: 1px solid #454545; }")

        preset_layout = QVBoxLayout(preset_group)
        preset_layout.setContentsMargins(10, 10, 10, 10)

        # Title
        preset_title = QLabel("Quick Select")
        ...
        self.preset_buttons = [
            ...
            (self._create_preset_button("Last Month", self._set_last_calendar_month), 1, 1),
    ...
    def _setup_custom_selection(self, parent_layout: QVBoxLayout) -> None:
        ...
        start_group.setStyleSheet("QFrame { background-color: #2d2d2d; border-radius: 4px; border: 1px solid #454545; }")
        start_layout = QVBoxLayout(start_group)

        # Start date label
        start_label = QLabel("Start Date")
        start_label.setStyleSheet("QLabel { font-weight: bold; color: #f0f0f0; }")
        ...
        time_label.setStyleSheet("color: #f0f0f0;")
        ...
        end_label.setStyleSheet("QLabel { font-weight: bold; color: #f0f0f0; }")
        ...
        end_time_label.setStyleSheet("color: #f0f0f0;")
    ...
    def _setup_preview_section(self, parent_layout: QVBoxLayout) -> None:
        ...
        # Preview label
        preview_label = QLabel("Selected Range:")
        preview_label.setStyleSheet("QLabel { font-weight: bold; color: #f0f0f0; }")
        ...
        # Time span
        self.timespan_label = QLabel("")
        self.timespan_label.setStyleSheet("QLabel { color: #aaaaaa; }")
    ...
    def paintEvent(self, event) -> None:
        ...
        if self.data_points:
            ...
            for point in self.data_points:
                ...
                painter.fillRect(int(point_x - 1), timeline_y - 2, 2, timeline_height + 4, QColor(40, 167, 69))
        ...
        if self.selection_start is not None and self.selection_end is not None:
            ...
            painter.drawLine(
                int(start_x), timeline_y - 5,
                int(start_x), timeline_y + timeline_height + 5
            )
            painter.drawLine(
                int(end_x), timeline_y - 5,
                int(end_x), timeline_y + timeline_height + 5
            )
