...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QSizePolicy, QFrame, QToolTip, QTabWidget,
    QStyle, QGridLayout, QButtonGroup, QRadioButton, QStackedWidget,
    QSplitter, QToolButton, QSpacerItem
)
from PyQt6.QtCore import Qt, QSize, pyqtSignal
from PyQt6.QtGui import (
    QPainter, QColor, QPen, QBrush, QIcon, QFont
)
...
class OptimizedTimelineTab(QWidget):
    ...
    def _create_control_panel(self) -> QFrame:
        ...
        self.filter_all_btn.setToolTip("Show all data points")
        self.filter_all_btn.clicked.connect(lambda: self._set_view_mode('both'))
        filter_layout.addWidget(self.filter_all_btn)

        self.filter_missing_btn = QPushButton("Missing")
        self.filter_missing_btn.setCheckable(True)
        self.filter_missing_btn.setToolTip("Show only missing data points")
        ...
        self.filter_available_btn = QPushButton("Available")
        self.filter_available_btn.setCheckable(True)
        self.filter_available_btn.setToolTip("Show only available data points")
        ...
        self.zoom_out_btn = QPushButton("−")  # Using Unicode minus sign
    ...
    def _create_view_selector(self) -> QWidget:
        ...
        self.view_header = QLabel("Timeline View")
    ...
    def _create_info_panel(self) -> QFrame:
        ...
        # Info section
        self.info_label = QLabel("No item selected")
        ...
        self.action_view_btn = QPushButton("View Details")
        ...
        self.action_download_btn = QPushButton("Download")
    ...
    def _toggle_visualization(self, index: int) -> None:
        ...
        if index == 0:
            self.view_header.setText("Timeline View")
        else:
            self.view_header.setText("Calendar View")
    ...
    def _update_info_panel(self) -> None:
        ...
        if self.selected_item:
            ...
            self.action_download_btn.setEnabled(not getattr(self.selected_item, 'is_downloaded', False) 
