...
class CacheInfoDialog(QDialog):
    ...
    def __init__(
        self, view_model: IntegrityCheckViewModel, parent: Optional[QWidget] = None
    ) -> None:
        super().__init__(parent)

        self.view_model = view_model

        self.setWindowTitle(self.tr("Cache Information"))
        ...
        # Info group
        info_group = QGroupBox(self.tr("Cache Statistics"))
        info_layout = QFormLayout()

        self.scan_count_label = QLabel(self.tr("0"))
        self.missing_count_label = QLabel(self.tr("0"))
        self.cache_size_label = QLabel(self.tr("0 MB"))
        self.last_scan_label = QLabel(self.tr("Never"))
        self.cache_path_label = QLabel(self.tr(""))
        ...
        # Management group
        management_group = QGroupBox(self.tr("Cache Management"))
    ...
    def _refresh_stats(self) -> None:
        ...
        if last_scan:
            ...
            self.last_scan_label.setText(self.tr("Never"))
...
class IntegrityCheckTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.date_range_selector.dateRangeSelected.connect(
