...
from PyQt6.QtGui import (
    QMouseEvent,  # QColor, QCursor, and QPixmap are unused
)
from PyQt6.QtWidgets import (
    QCheckBox,
    QComboBox,
    QDialog,
    QFileDialog,  # QDoubleSpinBox is unused
    QGridLayout,
    QGroupBox,
    QHBoxLayout,
    QLabel,
...
class MainTab(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.sanchez_res_combo.addItems([self.tr("0.5"), self.tr("1"), self.tr("2"), self.tr("4")])  # Keep other Sanchez options here
    ...
    def load_settings(self) -> None:
        ...
        try:
            ...
            LOGGER.debug(
                f"Setting tiling enabled: {tile_enabled} (raw value: {tile_enabled_raw}, type: {type(tile_enabled_raw)})"
            )
            ...
            LOGGER.debug(f"Setting resolution km: '{res_km_value}{res_km_value!r} not found in combo box, using default"
                )
