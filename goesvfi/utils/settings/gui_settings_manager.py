...
from .sections import MainTabSettings, FFmpegSettings, SanchezSettings, BasicSettings
...
class GUISettingsManager:
    ...
    def __init__(self, qsettings: QSettings, classifier: Optional[ErrorClassifier] = None):
