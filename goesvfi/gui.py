            ...
            if image_files:
                ...
                try:
                    ...
                    if sanchez_preview_enabled:
                        LOGGER.debug(
                            "Sanchez preview enabled. Attempting to get full-res processed_image from first_frame_label."  # noqa: B950
                        )
                        ...
                        if (
                            ...
                            LOGGER.debug(
                                "Successfully retrieved full-res processed_image from first_frame_label."  # noqa: B950
                            )
