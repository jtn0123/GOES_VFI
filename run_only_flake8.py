#!/usr/bin/env python3
"""
Script to run only Flake8 on the GOES_VFI codebase.
This is a temporary solution while the pylint issues are being fixed.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Run Flake8 on GOES_VFI codebase")
    parser.add_argument(
        "paths",
        nargs="*",
...
def main() -> int:
    """Run flake8 and return an exit code."""
    args = parse_args()
