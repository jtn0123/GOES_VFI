...
class TestPreviewFunctionalityOptimizedV2:
    ...
    def preview_test_components(self):
        ...
        class PreviewTestManager:
            ...
            def _setup_basic_loading(self, main_window, test_dir):
                ...
                with patch.object(main_window.main_view_model.preview_manager, "get_current_frame_data") as mock_get_data:
                    mock_data = [
            ...
            def _setup_memory_test(self, main_window, test_dir):
                ...
                with patch.object(main_window.main_view_model.preview_manager, "get_current_frame_data") as mock_get_data:
                    ...
                    memory_data = [
                        ImageData(array=np.random.randint(0, 256, (500, 500, 3), dtype=np.uint8), path=test_dir / "mem_001.png"),
                        ImageData(array=np.random.randint(0, 256, (500, 500, 3), dtype=np.uint8), path=test_dir / "mem_002.png"),
                        ImageData(array=np.random.randint(0, 256, (500, 500, 3), dtype=np.uint8), path=test_dir / "mem_003.png"),
                    ]
        ...
        class ClickTestHandler:
            ...
            def _setup_invalid_click(self, label):
    ...
    def temp_workspace(self, tmp_path):
        ...
        for dir_name, count, pattern in test_dir_configs:
    ...
    def test_preview_functionality_comprehensive_scenarios(self, shared_qt_app, preview_test_components, temp_workspace) -> None:
        ...
        for scenario in preview_scenarios:
            ...
            image_files = image_generator.create_test_sequence(
                test_dir,
                scenario["image_count"],
                scenario["pattern"]
            )
            ...
            with patch("goesvfi.integrity_check.combined_tab.CombinedIntegrityAndImageryTab"):
                with patch("goesvfi.integrity_check.enhanced_imagery_tab.EnhancedGOESImageryTab"):
                    ...
                    mock_preview_data = preview_manager.setup_scenario(
                        scenario["test_type"], main_window, test_dir
                    )
                    
                    # Verify initial state
                    assert main_window.in_dir is None, f"Initial in_dir should be None for {scenario['name']}"
                    assert hasattr(main_window.main_tab, "first_frame_label"), f"Missing first_frame_label for {scenario['name']}"
                    assert hasattr(main_window.main_tab, "last_frame_label"), f"Missing last_frame_label for {scenario['name']}"
    ...
    def test_preview_error_handling_comprehensive(self, shared_qt_app, preview_test_components, temp_workspace) -> None:
        ...
        for scenario in error_scenarios:
            if scenario["error_type"] == "click_error":
                ...
                # Generate test images
                image_files = image_generator.create_test_sequence(test_dir, 3, "solid")
                ...
                with patch("goesvfi.integrity_check.combined_tab.CombinedIntegrityAndImageryTab"):
                    with patch("goesvfi.integrity_check.enhanced_imagery_tab.EnhancedGOESImageryTab"):
                        ...
                        mock_preview_data = preview_manager.setup_scenario(
                            scenario["setup_type"], main_window, test_dir
                        )
    ...
    def test_preview_performance_and_memory_management(self, shared_qt_app, preview_test_components, temp_workspace) -> None:
        ...
        for scenario in performance_scenarios:
            if scenario["test_type"] == "performance":
                ...
                # Generate test images
                image_files = image_generator.create_test_sequence(
                    test_dir, scenario["image_count"], scenario["pattern"]
                )
                ...
                with patch("goesvfi.integrity_check.combined_tab.CombinedIntegrityAndImageryTab"):
                    with patch("goesvfi.integrity_check.enhanced_imagery_tab.EnhancedGOESImageryTab"):
                        ...
                        mock_preview_data = preview_manager.setup_scenario(
                            "performance", main_window, test_dir
                        )
                ...
                with patch("goesvfi.integrity_check.combined_tab.CombinedIntegrityAndImageryTab"):
                    with patch("goesvfi.integrity_check.enhanced_imagery_tab.EnhancedGOESImageryTab"):
                        ...
                        mock_preview_data = preview_manager.setup_scenario(
                            "memory_management", main_window, test_dir
                        )
    ...
    def test_preview_integration_with_gui_components(self, shared_qt_app, preview_test_components, temp_workspace) -> None:
        ...
        for scenario in integration_scenarios:
            ...
            # Generate test images
            image_files = image_generator.create_test_sequence(test_dir, 5, "gradient")
            ...
            with patch("goesvfi.integrity_check.combined_tab.CombinedIntegrityAndImageryTab"):
                with patch("goesvfi.integrity_check.enhanced_imagery_tab.EnhancedGOESImageryTab"):
                    ...
                    mock_preview_data = preview_manager.setup_scenario(
                        "basic_loading", main_window, test_dir
                    )
                    ...
                    if scenario["test_type"] == "file_picker":
                        ...
                        if hasattr(main_window, "settings"):
                            ...
                            with patch.object(main_window.settings, "setValue") as mock_set:
