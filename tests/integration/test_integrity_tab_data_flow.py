...
from PyQt6.QtWidgets import (
    QApplication, QMainWindow, QSplitter, QVBoxLayout, QWidget, QTabWidget
)
...
from goesvfi.integrity_check.satellite_integrity_tab_group import (
    OptimizedResultsTab, SatelliteIntegrityTabGroup
)
...
class TestIntegrityTabDataFlow(PyQtAsyncTestCase):
    ...
    async def test_scan_results_propagation(self):
        ...
        self.assertEqual(self.results_tab.tree_view.model._items, self.mock_missing_items)
