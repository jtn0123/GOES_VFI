...
class TestUIDatensityFunctionalityV2:
    ...
    def test_density_combo_box_exists_and_setup(self, mock_settings_tab):
    ...
    @pytest.mark.parametrize("config_density,expected_index", [
        ("0", 0),   # Normal
        ("-1", 1),  # Compact
        ("-2", 2),  # Very Compact
        ("1", 3),   # Spacious
    ...
    def test_density_scale_config_integration(self, mock_settings_tab, mock_config, config_density, expected_index):
    ...
    def test_density_scale_setting_changes(self, mock_settings_tab):
    ...
    def test_density_scale_signal_connections(self, mock_settings_tab):
    ...
    @pytest.mark.parametrize("combo_index,expected_config_value", [
        (0, "0"),   # Normal
        (1, "-1"),  # Compact
        (2, "-2"),  # Very Compact
        (3, "1"),   # Spacious
    ...
    def test_density_mapping_correctness(self, mock_settings_tab, combo_index, expected_config_value):
        ...
        def mock_get_settings():
            ...
            return {
                "theme": {
                    "density_scale": density_values[current_index]
                }
            }
    ...
    def test_theme_manager_density_scale_property(self, mock_theme_manager, mock_config):
        ...
        def mock_apply_theme(*args, **kwargs):
    ...
    def test_density_scale_ui_layout(self, mock_settings_tab):
    ...
    def test_reset_to_defaults_includes_density(self, mock_settings_tab):
    ...
    def test_density_persistence_on_reload(self, mock_settings_tab, mock_config, test_density):
    ...
    @pytest.mark.parametrize("invalid_density,expected_fallback", [
        ("invalid", 0),
        ("", 0),
        (None, 0),
        ("99", 0),
    ...
    def test_density_edge_cases(self, mock_settings_tab, mock_config, invalid_density, expected_fallback):
    ...
    @pytest.mark.parametrize("density_value,is_valid", [
        ("0", True),
        ("-1", True),
        ("-2", True),
        ("1", True),
    ...
    def test_density_validation_in_theme_manager(self, mock_theme_manager, density_value, is_valid):
    ...
    def test_density_functionality_integration(self, mock_config, mock_theme_manager):
    ...
    def test_density_combo_box_interaction(self, mock_settings_tab):
        """Test density combo box user interaction scenarios."""
        # Track interaction events
        interaction_events = []
        
        # Mock event handlers
        def mock_current_index_changed():
    ...
    def test_density_settings_consistency(self, mock_settings_tab, mock_config):
