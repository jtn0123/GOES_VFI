...
class TestWorkflowsIntegrationV2:
    ...
    def test_complete_processing_workflow(self, mock_main_window, test_images_data, signal_capture):
    ...
    @pytest.mark.parametrize("file_types,expected_behavior", [
        (["png", "jpg"], "accept_images"),
        (["mp4", "avi"], "accept_videos"),
        (["txt", "doc"], "reject_unsupported"),
        ([], "reject_empty"),
    ])
    def test_drag_drop_file_operations(self, mock_main_window, test_images_data, file_types, expected_behavior):
    ...
    def test_drag_drop_between_tabs(self, shared_app):
        ...
        def transfer_item(source_index):
    ...
    def test_batch_processing_queue(self, mock_main_window, test_images_data):
        ...
        class MockBatchProcessor:
            ...
            def _apply_job_settings(self, job):
    ...
    @pytest.mark.parametrize("processing_state,model_switch_scenario", [
        (True, "queued"),     # Processing - should queue
        (False, "immediate"), # Not processing - should switch immediately
    ])
    def test_model_switching_during_operation(self, mock_main_window, processing_state, model_switch_scenario):
    ...
    def test_cancellation_and_cleanup(self, mock_main_window, test_images_data):
    ...
    def test_pause_resume_workflow(self, mock_main_window):
    ...
    def test_multi_step_wizard_workflow(self, mock_main_window):
    ...
    def test_error_recovery_workflow(self, mock_main_window, signal_capture):
    ...
    def test_performance_monitoring_workflow(self, mock_main_window):
        ...
        class MockPerformanceMonitor:
            ...
            def record_resource_usage(self, memory_mb, cpu_percent):
            ...
            def get_performance_summary(self):
                ...
                if self.metrics["frame_processing_times"]:
                    avg_frame_time = sum(self.metrics["frame_processing_times"]) / len(self.metrics["frame_processing_times"])
