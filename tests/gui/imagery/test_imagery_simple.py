...
class MockPreviewDialog(QDialog):
    ...
    def initUI(self):
        ...
        header.setStyleSheet("background-color: #3F51B5; color: white; padding: 10px; font-weight: bold; font-size: 16px;")
        ...
        QTimer.singleShot(500, lambda: self.showFallbackPreview(
    ...
    def showFallbackPreview(self, error_msg):
        ...
        from PyQt6.QtGui import QPainter, QFont, QRect
