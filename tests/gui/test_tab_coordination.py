...
class TestTabCoordination:
    ...
    def test_integrity_check_repair_actions(self, qtbot, window, mocker):
        ...
        repair_mgr.queue_repair({'name': 'missing.nc', 'path': '/data/missing.nc', 'type': 'missing', 'url': 'http://example.com/missing.nc'})
    ...
    def test_tab_specific_shortcuts(self, qtbot, window):
        ...
        # Register shortcuts
        shortcut_mgr.register_shortcut('main', 'Ctrl+R', 
                                      lambda: actions_triggered.append('refresh_main'))
        shortcut_mgr.register_shortcut('models', 'Ctrl+D', 
                                      lambda: actions_triggered.append('download_model'))
        shortcut_mgr.register_shortcut('global', 'F1', 
                                      lambda: actions_triggered.append('show_help'))
