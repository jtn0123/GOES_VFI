...
class TestFastQtTestHelperV2:
    ...
    def test_mock_main_window_creation(self, mock_qt_helper, shared_app):
    ...
    @pytest.mark.parametrize("milliseconds,expected_iterations", [
        (0, 0),
        (10, 1),
        (50, 5),
        (100, 5),  # Capped at 5
    ...
    def test_fast_qtbot_wait(self, mock_qt_helper, shared_app, milliseconds, expected_iterations):
    ...
    def test_mock_heavy_operations_context_manager(self, mock_qt_helper):
...
class TestFastTestTimerV2:
    ...
    def test_timer_signal_connection(self, fast_timer):
    ...
    def test_multiple_callback_execution(self, fast_timer):
    ...
    def test_timer_start_with_intervals(self, fast_timer, interval):
    ...
    def test_timer_stop_and_isactive(self, fast_timer):
    ...
    def test_timer_reuse(self, fast_timer):
...
class TestOptimizeTestPerformanceV2:
        ...
        def optimize_test_performance(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                with patch("time.sleep", lambda x: None):  # No sleeping in tests
                    with patch("PyQt6.QtCore.QTimer") as mock_timer:  # Mock timers
    ...
    def test_decorator_application(self, mock_performance_decorator):
    ...
    def test_decorator_with_arguments(self, mock_performance_decorator):
        """Test decorator with function arguments."""
        results = []
        
        @mock_performance_decorator
        def parameterized_function(arg1, arg2, kwarg1=None):
    ...
    def test_decorator_exception_handling(self, mock_performance_decorator):
...
class TestMockedSettingsPersistenceV2:
    ...
    @pytest.mark.parametrize("path_value,expected_result", [
        ("/valid/path", True),
        ("relative/path", True),
        ("", True),  # Empty string is valid
        (None, False),  # None should return False
    ])
    def test_save_input_directory(self, mocked_settings, path_value, expected_result):
    ...
    @pytest.mark.parametrize("rect_value,expected_result", [
        ((10, 20, 100, 200), True),
        ([0, 0, 50, 50], True),
        ("rect_string", True),  # Any non-None value should work
        (None, False),  # None should return False
    ])
    def test_save_crop_rect(self, mocked_settings, rect_value, expected_result):
    ...
    def test_load_operations(self, mocked_settings):
    ...
    def test_storage_persistence_across_operations(self, mocked_settings):
...
class TestUtilityFunctionsV2:
    ...
    def test_assert_mock_called_with_retry(self, shared_app):
        ...
        def assert_mock_called_with_retry(mock_obj, *args, retries=3, delay=0.001):
    ...
    def test_fast_mock_s3_client_creation(self, mock_s3_client_factory):
    ...
    def test_s3_client_method_calls(self, mock_s3_client_factory):
    ...
    def test_integration_optimization_helpers(self, mock_qt_helper, mock_s3_client_factory, shared_app):
