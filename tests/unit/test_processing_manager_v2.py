...
class TestProcessingManagerOptimizedV2:
    ...
    def processing_manager_test_components(self):
        ...
        class ProcessingManagerTestManager:
            ...
            def create_signal_tracker(self, processing_manager: ProcessingManager) -> Dict[str, Union[bool, List[Any], Any]]:
                """Create a signal tracker for the processing manager."""
                emitted_signals: Dict[str, Union[bool, List[Any], Any]] = {
                    "started": False,
                    "progress": [],
                    "finished": None,
                    "error": None,
            ...
            def _test_validation(self, scenario_name: str, config_name: str, expected_valid: bool, expected_error: str) -> Dict[str, Any]:
            ...
            def _test_performance_validation(self, scenario_name: str) -> Dict[str, Any]:
                ...
                if scenario_name == "batch_validation":
                    ...
                    for config_name, expected_valid, expected_error in self.validation_scenarios:
                        processing_manager = self.create_processing_manager()
                        args = self.arg_configs[config_name]
        ...
        return {
            "manager": ProcessingManagerTestManager(),
            "app": app
        }
    ...
    @pytest.mark.parametrize("config_name,expected_valid,expected_error", [
        ("valid_basic", True, ""),
        ("valid_complete", True, ""),
        ("missing_input", False, "No input directory"),
        ("invalid_input", False, "does not exist"),
    ...
    def test_argument_validation_scenarios(self, processing_manager_test_components, config_name, expected_valid, expected_error) -> None:
        """Test argument validation scenarios."""
        manager = processing_manager_test_components["manager"]
