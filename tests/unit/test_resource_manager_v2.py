"""Optimized tests for ResourceManager with comprehensive coverage maintained.

This v2 version maintains all test scenarios while optimizing through:
- Comprehensive resource management testing with all original functionality
- Enhanced executor testing with concurrent access scenarios
- Complete memory monitoring and callback testing
- Global singleton behavior validation
- Memory estimation function coverage
- Managed executor convenience function testing
"""
...
class TestResourceLimitsV2:
    """Comprehensive tests for ResourceLimits dataclass."""
...
class TestResourceManagerV2:
    """Comprehensive ResourceManager tests with full coverage."""
...
class TestGlobalResourceManagerV2:
...
class TestEstimateProcessingMemoryV2:
