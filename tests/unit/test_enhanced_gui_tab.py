...
class TestEnhancedIntegrityCheckTab(PyQtAsyncTestCase):
    ...
    def test_auto_detect_satellite_goes16(self, mock_message_box, mock_scan, mock_progress_dialog):
        ...
        mock_progress_instance.setWindowTitle.assert_called_with("Detecting Satellite Type")
    ...
    @patch('goesvfi.integrity_check.time_index.TimeIndex.scan_directory_for_timestamps')
    @patch('goesvfi.integrity_check.enhanced_gui_tab.QMessageBox')
    def test_auto_detect_satellite_goes18(self, mock_message_box, mock_scan, mock_progress_dialog):
    ...
    @patch('goesvfi.integrity_check.time_index.TimeIndex.scan_directory_for_timestamps')
    @patch('goesvfi.integrity_check.enhanced_gui_tab.QMessageBox')
    def test_auto_detect_satellite_no_files(self, mock_message_box, mock_scan, mock_progress_dialog):
