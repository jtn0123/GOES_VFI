...
def test_status_signal_emitted(main_window_vm, qtbot) -> None:
...
def test_active_tab_signal_emitted(main_window_vm, qtbot) -> None:
...
def test_processing_vm_has_dependencies(main_window_vm) -> None:
