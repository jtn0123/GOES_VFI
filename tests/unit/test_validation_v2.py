...
class TestValidationOptimizedV2:
    ...
    @pytest.mark.parametrize("path_type,must_be_dir,should_succeed", [
    ...
    def test_validate_path_exists_valid_scenarios(self, test_directory_structure, path_type, must_be_dir, should_succeed) -> None:
    ...
    @pytest.mark.parametrize("invalid_value,expected_exception,error_pattern", [
