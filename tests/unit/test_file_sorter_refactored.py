...
from goesvfi.file_sorter.sorter_refactored import DEFAULT_BUFFER_SIZE, DEFAULT_TIME_TOLERANCE_SECONDS, DuplicateMode, FileSorter
...
class TestFileSorterHelpers:
    ...
    def test_process_single_file_identical(self, sorter, tmp_path):
        ...
        message = sorter._process_single_file(
            source_file, dest_file, source_mtime, source_size, True  # files_are_identical=True
        )
    ...
    def test_process_single_file_new(self, sorter, tmp_path):
        ...
        with mock.patch.object(sorter, 'copy_file_with_buffer') as mock_copy:
            message = sorter._process_single_file(
                source_file, dest_file, source_mtime, source_size, False  # files_are_identical=False
            )
