...
class TestTimeIndex(unittest.TestCase):
    ...
    def test_to_s3_key(self):
        ...
        s3_key_actual = to_s3_key(self.test_date_old, SatellitePattern.GOES_16, 
                                  product_type="RadC", band=13)
        ...
        key = TimeIndex.to_s3_key(self.test_date_old, SatellitePattern.GOES_18, 
                                 product_type="RadC", band=13)
        # Get the exact key generated by the function for the test
        s3_key_actual = to_s3_key(self.test_date_old, SatellitePattern.GOES_18, 
                                 product_type="RadC", band=13)
        self.assertEqual(key, s3_key_actual)
        
        # GOES-16 S3 key with RadF product type
        key = TimeIndex.to_s3_key(self.test_date_old, SatellitePattern.GOES_16, 
                                 product_type="RadF", band=13)
        # Get the exact key generated by the function for the test
        s3_key_actual = to_s3_key(self.test_date_old, SatellitePattern.GOES_16, 
                                 product_type="RadF", band=13)
        self.assertEqual(key, s3_key_actual)
