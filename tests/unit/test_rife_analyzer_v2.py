...
class TestRifeCapabilityDetectorV2:
    ...
    def test_init_successful_detection(self, rife_path, mock_subprocess):
    ...
    def test_init_exe_not_found(self, rife_path):
        """Test initialization when executable not found."""
        with patch("pathlib.Path.exists", return_value=False):
            with pytest.raises(FileNotFoundError, match="not found"):
                RifeCapabilityDetector(rife_path)

    def test_init_help_command_fails(self, rife_path, mock_subprocess):
    ...
    def test_version_detection(self, rife_path, mock_subprocess):
    ...
    def test_capability_detection_partial_support(self, rife_path):
    ...
    def test_detect_capabilities_with_simulated_help(self, rife_path):
    ...
    def test_help_command_timeout(self, rife_path, mock_subprocess):
    ...
    def test_build_command_basic(self, rife_path, mock_subprocess):
    ...
    def test_build_command_with_capabilities(self, rife_path, mock_subprocess):
    ...
    def test_build_command_ignores_unsupported(self, rife_path):
...
class TestAnalyzeRifeExecutableV2:
    ...
    def test_analyze_successful(self, mock_detector):
    ...
    def test_analyze_detection_error(self):
    ...
    def test_analyze_edge_cases(self, mock_detector):
