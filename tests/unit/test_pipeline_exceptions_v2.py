...
from typing import Any, Dict, List, Never, Type
...
class TestPipelineExceptionsOptimizedV2:
    ...
    def exception_test_components(self):
        ...
        class ExceptionTestManager:
            ...
            def _test_attribute_validation(self, exception_name: str, config: Dict[str, Any]) -> Dict[str, Any]:
                ...
                exception_class = config["class"]
                attributes = config["has_attributes"]
                test_message = config["test_messages"][0]
            ...
            def _test_scenario_validation(self, exception_name: str, config: Dict[str, Any]) -> Dict[str, Any]:
                ...
                exception_class = config["class"]
                test_messages = config["test_messages"]
    ...
    def test_exception_scenario_validation(self, exception_test_components) -> None:
        ...
        scenario_exceptions = ["rife_error", "sanchez_error", "input_error", "output_error", "resource_error", "configuration_error"]
    ...
    def test_realistic_pipeline_scenarios(self, exception_test_components) -> None:
        ...
        assert len([k for k in results.keys() if k.startswith("scenario_")]) == 4
    ...
    @pytest.mark.parametrize("exception_name,test_messages", [
    ...
    def test_exception_edge_cases(self, exception_test_components) -> None:
        ...
        # Test empty messages
        for exception_class in [PipelineError, ProcessingError, FFmpegError, RIFEError, 
                               SanchezError, InputError, OutputError, ResourceError, ConfigurationError]:
