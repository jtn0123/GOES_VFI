    ...
    def test_to_s3_key(self):
        ...
        self.assertTrue(
            key_radf_g16.startswith(
                f"ABI-L1b-RadF/2022/001/00/OR_ABI-L1b-RadF-M6C13_G16_s20220010"
            )
        )
        ...
        self.assertTrue(
            key_radf_g18.startswith(
                f"ABI-L1b-RadF/2022/001/00/OR_ABI-L1b-RadF-M6C13_G18_s20220010"
            )
        )
        ...
        self.assertTrue(
            key_radc_g16.startswith(
                f"ABI-L1b-RadC/2022/001/00/OR_ABI-L1b-RadC-M6C13_G16_s20220010"
            )
        )
        ...
        self.assertTrue(
            key_band1.startswith(
                f"ABI-L1b-RadF/2022/001/00/OR_ABI-L1b-RadF-M6C01_G16_s20220010"
            )
        )
